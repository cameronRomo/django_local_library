# Generated by Django 6.0.2 on 2026-03-12 00:07
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                'constraints': [models.UniqueConstraint(django.db.models.functions.text.Lower('name'), name='genre_name_ci_unique', violation_error_message='A genre with this name already exists (case insensitive match).')],
            },
        ),
        migrations.AddField(
            model_name='book',
